...
def create_polygons(csv):
    ...
    #pour ajouter les coordonnées à la liste qui deviendra le csv
...
def match_polygons(polygons1, polygons2):
    ...
    for color, points_list2 in groups2.items():
        ...
        matched_polygons[color] = []

        #les ids qui sont correspondant sont dans cette liste
        matched_ids = set()  
